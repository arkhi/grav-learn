...
This definition creates a collection for the page that consists of all the **child pages** sorted by **date** in **descending** order with **pagination** showing **10 items** per-page.
